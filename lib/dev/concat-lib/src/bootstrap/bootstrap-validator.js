(function($){
	...
	var pb_validator = window.pb_validator = (function(target_, options_){
		...
		this._inputs.on("change focusout keyup",$.proxy(function(event_){
			var module_ = this;
			...
			$.each(this._options['validators'], function(key_, validator_){
	...
	pb_validator.DEFAULTS = {
		delay: 300,
		input_selector : ':input:not([type="hidden"], [type="submit"], [type="reset"], button)',
