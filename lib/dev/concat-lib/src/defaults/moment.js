;(function (global, factory) {
    ...
    var lb = moment__default.defineLocale('lb', {
        ...
        monthsParseExact : true,
        weekdays: 'Sonndeg_Méindeg_Dënschdeg_Mëttwoch_Donneschdeg_Freideg_Sahthdeg'.split('_'),
    ...
    var sq = moment__default.defineLocale('sq', {
        months : 'Janar_Shkurt_Mars_Prill_Maj_Qershor_Korrik_Gusnj_Shtator_Tetor_Nëntor_Dhjetor'.split('_'),
        monthsShort : 'Jan_Shk_Mar_Pri_Maj_Qer_Kor_Gus_Snj_Tet_Nën_Dhj'.split('_'),
    ...
    var tzl = moment__default.defineLocale('tzl', {
        months : 'Januar_Fevraglh_Març_Avrïu_Mai_Gün_Julia_Guscnj_Setemvar_Listopäts_Noemvar_Zecemvar'.split('_'),
