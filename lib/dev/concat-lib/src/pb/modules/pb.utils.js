(function($){
	...
	$.fn.delay_on = function(event_, func_, delay_){
		delay_ = delay_ === undefined ? 300 : delay_;
		var bind_key_ = 'delay_on_'+PB.random_string(5);
		
		this.on(event_, $.proxy(function(event_){
			clearTimeout(this['bind_key']);
			this['event'] = event_;

			this['target_el'].data(this['bind_key'], setTimeout($.proxy(function(){
				this['func'].apply(this['target_el'], [this['event']]);
			}, this),this['delay']));
