(function($){
			...
			'<div class="modal-dialog">' +
				'<div class="modal-content">' +
					'<div class="modal-body">' +
						'<input id="pb-image-input-uploader-modal-input-'+this._modal_uid+'" type="file" name="files[]" accept="image/*" multiple>' +
					'</div>' +
	...
	_pb_image_input.prototype.update_image = (function(data_){
		...
		var preview_el_ = $("<div class='preview'></div>");
			preview_el_.css({
				'backgroundImage' : "url(\""+PBVAR['home_url']+"uploads/"+data_['upload_path']+(data_['thumbnail'])+"\")"
			});
