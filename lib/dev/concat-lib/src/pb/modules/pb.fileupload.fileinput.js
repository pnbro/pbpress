(function($){
	...
	var _pb_file_input = function(target_, options_){
		...
		this._options = $.extend(true, {
			'upload_path' : null,
			'accept' : window.pb_file_input.default['accept'],
			'modal_label' : window.pb_file_input.default['modal_label'],
			'modal_desc' : window.pb_file_input.default['modal_desc'],
			...
			'<div class="modal-dialog">' +
				'<div class="modal-content">' +
					'<div class="modal-body">' +
						'<input id="pb-file-input-uploader-modal-input-'+this._modal_uid+'" type="file" name="files[]" accept="'+this._options['accept']+'" multiple>' +
					'</div>' +
