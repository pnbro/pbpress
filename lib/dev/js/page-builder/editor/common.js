...
jQuery(document).ready(function(){
	pb_page_builder.add_element_edit_library('row', {
		preview : function(element_data_, content_){
			return "<div class='preview-item'>"+(element_data_['columns'] ? element_data_['columns'] : "12")+"</div>";
		}
	});
	pb_page_builder.add_element_edit_library('container', {
		preview : function(element_data_, content_){
			...
			if(element_data_['container_type'] === "full") return "<div class='preview-item'>꽉채움</div>";
