jQuery(document).ready(function(){
	...
	var splitted_view_module_ = splitted_view_el_.pb_splitted_view({
		'master-info-load-action' : "pb-admin-gcode-load",
		'master-info-loaded' : function(master_data_){
			var extra_thead_cols_ = $("#pb-gcode-dtl-listtable").find("thead > tr > th[class*='extra-col']");
			var extra_tbody_cols_ = $("#pb-gcode-dtl-listtable").find("tbody > tr > td[class*='extra-col']");
