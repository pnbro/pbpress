...
function _pb_manage_site_update_settings(){
	var settings_form_ = $("#pb-manage-site-form");
	PB.post_url(PBVAR['home_url']+"/admin/_ajax_update_site_settings.php", {
		settings_data : pb_apply_filters('pb-manage-site-update-settings', settings_form_.serialize_object()),
...
function _pb_manage_site_reinstall_tables(){
	...
	PB.post_url(PBVAR['home_url']+"/admin/_ajax_reinstall_tables.php", {
