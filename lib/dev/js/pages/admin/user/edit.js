...
function _pb_manage_user_do_update(){
	...
	if(typeof request_data_['user_authority'] === "string"){
	...
	PB.post("pb-admin-manage-user-do-update",{
		...
		if(!result_ || response_json_.success !== true){
			PB.alert({
				...
				content : response_json_.error_message || __("사용자 정보 수정 중, 에러가 발생했습니다."),
			});
			return;
		}
