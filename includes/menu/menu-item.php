...
function pb_menu_item_insert($raw_data_){
	...
	pb_hook_do_action("pb_menu_item_inserted", pb_menu($insert_id_));
	return $insert_id_;
}
...
function pb_menu_item_update($id_, $raw_data_){
	...
	pb_hook_do_action("pb_menu_item_updated", pb_menu($id_));
...
function pb_menu_item_delete($id_){
	...
	pb_hook_do_action("pb_menu_item_deleted", pb_menu($id_));
	return $result_;
}
