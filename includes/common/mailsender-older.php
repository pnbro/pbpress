...
require(PB_DOCUMENT_PATH."includes/common/lib/phpmailer/older/class.phpmailer.php");
require(PB_DOCUMENT_PATH."includes/common/lib/phpmailer/older/class.smtp.php");

class PBMailSender_older extends PBMailSender{
...
function _pb_mail_sender_types_older($results_){
	$results_['older'] = 'PBMailSender_older';
	return $results_;
}
pb_hook_add_filter('pb_mail_sender_types', '_pb_mail_sender_types_older');
