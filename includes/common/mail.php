		...
		<div class="panel-body">
				...
				<script type="text/javascript">
					jQuery(document).ready(function(){
						...
						$("#pb-manage-site-form-mail_template").pb_wysiwyg_editor_hugerte({
							lang : "<?=pb_editor_hugerte_language(pb_current_locale())?>",
...
function _pb_mail_hook_update_site_settings($settings_data_){
	...
	pb_clob_option_update("mail_smtp_user_pass", isset($settings_data_['mail_smtp_user_pass']) ? $settings_data_['mail_smtp_user_pass'] : null, true);
